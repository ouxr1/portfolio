    ...
    <Col lg="6" xs={12}>
      <div className="services-thumb">
        <div className="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
          <h3 className="mb-0">{props.service}</h3>

          <div className="services-price-wrap ms-auto">
            <p className="services-price-text mb-0">{props.price}</p>
        ...
        <div className="services-icon-wrap d-flex justify-content-center align-items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="services-icon bi bi-globe" viewBox="0 0 16 16">
